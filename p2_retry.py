...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='./save/p2_retry-5way-1kshot-15qquery-200m-1000epoch-Conv_G')
    #parser.add_argument('--gpu', default='0')
    parser.add_argument('--train_data_dir')
    parser.add_argument('--train_csv')
    parser.add_argument('--val_data_dir')
    parser.add_argument('--val_csv')
    parser.add_argument('--m_augment', type=int, default=200)
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=100, gamma=0.5) #每過100個epoch => lr = lr * gamma
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        for i, batch in enumerate(train_loader, 1):
            ...
            x = x.view(x.size(0), -1)
            logits = euclidean_metric(x, proto)
            ###############################################################################cosine
            '''
